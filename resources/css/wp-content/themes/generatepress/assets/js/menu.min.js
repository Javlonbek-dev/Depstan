! function() {
    ...
    if ("querySelector" in document && "addEventListener" in window) {
        ...
        var o = function(t) {
            ...
            u = function(e) {
                if (e && a.classList.contains("dropdown-hover")) {
                    ...
                    for (f = 0; f < t.length; f++) t[f].querySelector(".dropdown-menu-toggle").removeAttribute("tabindex"), t[f].querySelector(".dropdown-menu-toggle").setAttribute("role", "presentation"), t[f].querySelector(".dropdown-menu-toggle").removeAttribute("aria-expanded"), t[f].querySelector(".dropdown-menu-toggle").removeAttribute("aria-label")
                }
            },
            r = function(e) {
            ...
            s = function(e, t) {
                ...
                if (n = (t = t || this).getAttribute("data-nav") ? document.getElementById(t.getAttribute("data-nav")) : document.getElementById(t.closest("nav").getAttribute("id"))) {
                    ...
                    if (n.classList.contains("toggled")) n.classList.remove("toggled"), c.classList.remove("mobile-menu-open"), o && o.setAttribute("aria-hidden", "true"), t.setAttribute("aria-expanded", "false"), (s || l && n.classList.contains("main-navigation")) && l.classList.remove("toggled"), u(o);
                    else {
                        n.classList.add("toggled"), c.classList.add("mobile-menu-open"), o && o.setAttribute("aria-hidden", "false"), t.setAttribute("aria-expanded", "true"), s ? (l.classList.add("toggled"), l.querySelector(".search-item") && l.querySelector(".search-item").classList.contains("active") && l.querySelector(".search-item").click()) : l && n.classList.contains("main-navigation") && l.classList.add("toggled");
                        t = o;
                        if (t && a.classList.contains("dropdown-hover")) {
                            var r = t.querySelectorAll("li.menu-item-has-children");
                            for (f = 0; f < r.length; f++) r[f].querySelector(".dropdown-menu-toggle").setAttribute("tabindex", "0"), r[f].querySelector(".dropdown-menu-toggle").setAttribute("role", "button"), r[f].querySelector(".dropdown-menu-toggle").setAttribute("aria-expanded", "false"), r[f].querySelector(".dropdown-menu-toggle").setAttribute("aria-label", generatepressMenu.openSubMenuLabel)
                        }
                    }
                }
            };
        ...
        for (f = 0; f < t.length; f++) t[f].addEventListener("click", i, !1), t[f].addEventListener("keypress", function(e) {
            ...
            for (f = 0; f < e.length; f++) {
                ...
                if ((t = l && !t.closest("nav").classList.contains("mobile-menu-control-wrapper") ? l.querySelector(".menu-toggle") : t) && null === t.offsetParent) {
                    if (e[f].classList.contains("toggled")) {
                        var n, s, o, r = !1;
                        if ((r = e[f].classList.contains("mobile-menu-control-wrapper") ? !0 : r) || (s = (n = e[f].getElementsByTagName("ul")[0]) ? n.getElementsByTagName("li") : [], o = n ? n.getElementsByTagName("ul") : []), document.activeElement.blur(), e[f].classList.remove("toggled"), c.classList.remove("mobile-menu-open"), t.setAttribute("aria-expanded", "false"), !r) {
        ...
        if (window.addEventListener("resize", d, !1), window.addEventListener("orientationchange", d, !1), a.classList.contains("dropdown-hover"))
            for (f = 0; f < n.length; f++) n[f].addEventListener("click", function(e) {
                var t;
        ...
        if (a.classList.contains("dropdown-hover")) {
            for (var g = document.querySelectorAll(".menu-bar-items .menu-bar-item > a"), m = function() {
                ...
                }, f = 0; f < n.length; f++) n[f].addEventListener("focus", m), n[f].addEventListener("blur", m);
        ...
        if ("ontouchend" in document.documentElement && document.body.classList.contains("dropdown-hover")) {
            ...
            for (f = 0; f < p.length; f++) p[f].addEventListener("touchend", function(e) {
